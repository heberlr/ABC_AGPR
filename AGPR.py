...
# MaxStdDiffMean = np.array(MaxStdDiffMean)
# iteration = np.arange(0,MaxStdDiffMean.shape[0],1)
# plt.plot(iteration,MaxStdDiffMean, marker='o', color='r')
# plt.title('Difference between max(std) and mean(std)')
